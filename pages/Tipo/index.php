            ...
            <div class="d-flex justify-content-center flex-wrap container_cards">
                <div class="card" style="width: 24rem;height: 16rem;">
                    ...
                    <div class="card-body d-flex flex-column justify-content-end">
                        ...
                        <p class="card-text">Faça Suas Vendas De Forma Facil, Conquistando Muitos Clientes.</p>
                ...
                <div class="card" style="width: 24rem;height: 16rem;">
                    ...
                    <div class="card-body d-flex flex-column justify-content-end">
                        ...
                        <p class="card-text">Faça Suas Compras De Forma Facil. Em Apenas Alguns Cliques!</p>
